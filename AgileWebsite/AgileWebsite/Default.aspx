  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover">
        <h1 class="cover-heading">Online Research Funding Application</h1>
        <p class="lead">A tool created students to help you get the funding you deserve!</p>
        <p class="lead">
          <a href="Login.aspx" class="btn btn-lg btn-primary">Sign In</a>
            <a href="Register.aspx" class="btn btn-lg btn-success">Register</a>
        </p>
      </main>
